  ...
  return (
    <div className="min-h-screen pb-20">
      ...
      <div className="relative overflow-hidden bg-white border-b border-slate-200">
        ...
        <div className="absolute top-0 right-0 -mr-40 -mt-40 w-96 h-96 rounded-full bg-primary-100/50 blur-3xl opacity-50 mix-blend-multiply" />
        <div className="absolute bottom-0 left-0 -ml-40 -mb-40 w-96 h-96 rounded-full bg-indigo-100/50 blur-3xl opacity-50 mix-blend-multiply" />

        <div className="relative max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-20 text-center">
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-primary-50 text-primary-700 font-semibold text-sm mb-6 border border-primary-100 shadow-sm">
            <Sparkles className="w-4 h-4" />
            Welcome to NexusQR
          </div>
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-extrabold text-slate-800 tracking-tight mb-6 leading-tight">
      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        <div className="grid md:grid-cols-3 gap-8 relative">
          ...
          <div className="hidden md:block absolute top-[44px] left-[15%] right-[15%] h-0.5 bg-gradient-to-r from-slate-100 via-slate-200 to-slate-100 z-0" />

          {/* Step 1 */}
          <div className="relative z-10 flex flex-col items-center text-center group">
            <div className="w-24 h-24 mb-6 rounded-2xl bg-white border border-slate-100 shadow-xl shadow-slate-200/50 p-1 flex items-center justify-center transition-transform duration-500 group-hover:-translate-y-2 group-hover:shadow-primary-500/20">
              <div className="w-full h-full rounded-xl bg-primary-50 flex items-center justify-center text-primary-600">
                <BookOpen className="w-8 h-8" />
              </div>
              <div className="absolute -top-3 -right-3 w-8 h-8 bg-slate-800 text-white rounded-full flex items-center justify-center font-bold text-sm shadow-sm ring-4 ring-white">
                1
              </div>
            </div>
          ...
          {/* Step 2 */}
          <div className="relative z-10 flex flex-col items-center text-center group">
            <div className="w-24 h-24 mb-6 rounded-2xl bg-white border border-slate-100 shadow-xl shadow-slate-200/50 p-1 flex items-center justify-center transition-transform duration-500 group-hover:-translate-y-2 group-hover:shadow-indigo-500/20">
          ...
          {/* Step 3 */}
          <div className="relative z-10 flex flex-col items-center text-center group">
            <div className="w-24 h-24 mb-6 rounded-2xl bg-white border border-slate-100 shadow-xl shadow-slate-200/50 p-1 flex items-center justify-center transition-transform duration-500 group-hover:-translate-y-2 group-hover:shadow-emerald-500/20">
        ...
        <div className="mt-24 grid md:grid-cols-2 gap-6">
          ...
          <div className="bg-white border border-slate-200 rounded-3xl p-8 md:p-10 text-slate-800 shadow-card hover:shadow-card-hover transition-shadow duration-500 relative overflow-hidden group">
            <div className="absolute top-0 right-0 -mr-8 -mt-8 w-40 h-40 bg-amber-50 rounded-full blur-2xl group-hover:bg-amber-100 transition-colors duration-500"></div>
